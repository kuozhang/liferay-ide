...
public class AlloyTestsUtils extends UITestsUtils
{
    ...
    private static int templateOffset = 903;

    public static ICompletionProposal[] getWebSevicesProposals( IFile file ) throws Exception
    {
        System.out.println(FileUtil.readContents( file.getContents() ));
        ...
        final String partitionTypeID = viewer.getDocument().getPartition( 903 ).getType();
